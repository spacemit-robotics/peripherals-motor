...
int HLSCL::WheelMode(u8 ID) { return writeByte(ID, HLSCL_MODE, 1); }

int HLSCL::EleMode(u8 ID) { return writeByte(ID, HLSCL_MODE, 2); }
...
int HLSCL::EnableTorque(u8 ID, u8 Enable) { return writeByte(ID, HLSCL_TORQUE_ENABLE, Enable); }
...
int HLSCL::LockEprom(u8 ID) { return writeByte(ID, HLSCL_LOCK, 1); }
...
int HLSCL::ServoMode(u8 ID) { return writeByte(ID, HLSCL_MODE, 0); }
